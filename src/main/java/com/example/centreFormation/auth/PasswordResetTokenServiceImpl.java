...
import com.example.centreFormation.email.ChangePasswordResetRequest;
import com.example.centreFormation.email.EmailDetails;
import com.example.centreFormation.email.EmailService;
...
public class PasswordResetTokenServiceImpl implements PasswordResetTokenService {
    ...
    @Override
    public ResponseEntity<String> changePasswordHandler(ChangePasswordResetRequest changePasswordResetRequest, String email) {
        return null;
    }
