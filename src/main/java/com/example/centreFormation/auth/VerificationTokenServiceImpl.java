...
import com.example.centreFormation.config.securityRepository.TokenVerificationRepository;
...
public class VerificationTokenServiceImpl implements VerificationTokenService {
    ...
    public void saveUserVerificationToken(User user, String token) {
        var verificationToken = new TokenVerification(token,user);
    ...
    @Override
    public TokenVerification generateNewVerificationToken(String oldToken) {
       TokenVerification verificationToken = tokenRepository.findByToken(oldToken);
        var verificationTokenTime = new TokenVerification();
